...
const cases = [
  ...
  ['tests/fixtures/events.bend', ['quoted'], 'Event signatures must be ABI signatures'],
  ['tests/fixtures/events.bend', ['short'], 'one word for each parameter'],
  ['tests/fixtures/events.bend', ['wide'], 'at most three indexed words'],
